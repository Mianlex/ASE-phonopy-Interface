...
for k,LC in enumerate(LatticeConstant):
    ...
    atoms.write('POSCAR')
    os.system("phonopy -d --dim='9 9 9'")##generate displacements and super cell
    ...
    n='%02d' %k
    print(n)
    os.system("phonopy -t -p -s --tmax=2000 --dim='9 9 9' --mp='64 64 64'")#write the parameter of the thermal properties
